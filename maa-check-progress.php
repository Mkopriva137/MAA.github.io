...
<section>
    <div id="welcome-container">
        <h1>Your Progress</h1><br><br>
        <div id="progress">
            Your current rank is:<input type="text" name="belt"><br><br>
            Date last tested:<input type="text" name="date"><br><br>
            Number of stripes:<input type="text" name="stripes"><br><br>
            Hours until eligible for testing:<input type="text" name="hours"><br><br>
        </div>
    </div>
</section>
