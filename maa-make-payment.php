...
<section>
    <div id="welcome-container">
        <h1>Testing Form  (Cost = $20.00)</h1><br>
        <div id="payment">
        <form action="maa test form.php" method="post">
            ...
            Todays Date:<br><input type="text" name="date" placeholder="MM-DD-YYYY" id="student-info"><br><br><br><br>
